...
=== Compare the transposed rust and omp implementation

=== Compare the untransposed omp, unsafe rust, paired rust and collect rust implementations

=== Compare the rust implementations using mutexes with itself?
